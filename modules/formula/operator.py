    ...
    if token["value"] in [
        ...
        if token["value"] == "+":
            ...
            if type(left) is str or type(right) is str:
                stack.append(
                    {"type": TOKENTYPE.STRING, "value": str(left) + str(right)}
                )
            else:
